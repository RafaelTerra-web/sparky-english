...
export default function PrivacyPage() {
  ...
  return (
    <main className="privacy-page">
      ...
      <p>{t("Conclusões, datas de revisão, moedas, inventário, roupas equipadas e o mascote escolhido são compactados em um segundo cookie criptografado, inacessível ao JavaScript e ligado ao identificador da sua Conta Google. Ele pode permanecer neste navegador por até um ano mesmo depois do logout, para que o progresso reapareça no próximo acesso da mesma conta. Contas diferentes usam estados separados.")}</p>
      <p>{t("Com a sincronização por conta ativa, conclusões, revisões, moedas e inventário ficam no Supabase, sob um identificador derivado da conta Google. O servidor verifica a sessão e controla os acessos. O Perfil informa o modo ativo. Respostas de autenticação e dados privados não entram no cache offline. Uma falha ao salvar é mostrada ao aluno.")}</p>
