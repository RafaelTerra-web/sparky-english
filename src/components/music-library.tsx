...
import { Volume2, ChevronDown, SkipBack, SkipForward, SlidersHorizontal, Headphones, ArrowRight, Play, Pause, RotateCcw, Mic, Square, Bookmark, Check, } from 'lucide-react';
